...
tf.flags.DEFINE_string("TEST_DIR",  "./../../02_data_enc_dec/04_data_10s_icb/data/data_test/", "Directory of feature")
tf.flags.DEFINE_string("OUT_DIR",       "./data/",                                   "Point to output directory")

tf.flags.DEFINE_integer("N_VALID",           2756,   "Valid file number")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        mid_layer_test_dir = os.path.abspath(os.path.join(stored_dir, "02_mid_test_extr"))
        ...
        def test_process(x_test_batch):
            ...
            [step, wanted_data] = sess.run([global_step, model.latent], feed_dict)
