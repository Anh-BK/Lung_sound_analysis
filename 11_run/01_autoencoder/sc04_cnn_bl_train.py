...
tf.flags.DEFINE_string("PRE_TRAIN_DIR",  "./../../02_data_enc_dec/04_data_10s_icb/data/data_pre_train/", "Directory of feature")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        full04_layer_res_dir = os.path.abspath(os.path.join(stored_dir, "03_mid_train_extr"))
        ...
        #for nTestClass in range(0,1):
            ...
            #for nFileTest in range(0,5):
                ...
                test_file_name, ext = os.path.splitext(test_file_list[nFileTest])
                test_file_name, ext = os.path.splitext(test_file_name)

                full04_layer_file = os.path.abspath(os.path.join(full04_layer_res_dir, test_file_name ))
                #print(full04_layer_file)
                #exit()
