% For saving TODO
mkdir('./../12_group_wavelet_10s_4000_icb');
mkdir('./../12_group_wavelet_10s_4000_icb/data_train');
mkdir('./../12_group_wavelet_10s_4000_icb/data_test');
opts.save_train_dir = './../12_group_wavelet_10s_4000_icb/data_train/';
opts.save_test_dir  = './../12_group_wavelet_10s_4000_icb/data_test/';

% For input data TODO
opts.train_dir  =  '../12_split_wavelet_10s_4000_icb/data_train/';
opts.test_dir   =  '../12_split_wavelet_10s_4000_icb/data_test/';
