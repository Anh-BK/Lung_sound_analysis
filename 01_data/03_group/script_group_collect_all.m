% For saving TODO
mkdir('./../12_group_gam_10s_f3');
mkdir('./../12_group_gam_10s_f3/data_train');
mkdir('./../12_group_gam_10s_f3/data_test');
opts.save_train_dir = './../12_group_gam_10s_f3/data_train/';
opts.save_test_dir  = './../12_group_gam_10s_f3/data_test/';

% For input data TODO
opts.train_dir  =  '../12_split_gam_10s_f3/data_train/';
opts.test_dir   =  '../12_split_gam_10s_f3/data_test/';
