% For saving TODO
mkdir('./../12_group_W_C_N_ran');
mkdir('./../12_group_W_C_N_ran/data_train');
mkdir('./../12_group_W_C_N_ran/data_test');
opts.save_train_dir = './../12_group_W_C_N_ran/data_train/';
opts.save_test_dir  = './../12_group_W_C_N_ran/data_test/';

% For input data TODO
opts.train_dir  =  '../12_split_W_C_N_ran/data_train/';
opts.test_dir   =  '../12_split_W_C_N_ran/data_test/';
