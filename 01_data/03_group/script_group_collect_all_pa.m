% For saving TODO
mkdir('./../12_group_mel_pa');
mkdir('./../12_group_mel_pa/data_train');
mkdir('./../12_group_mel_pa/data_test');
opts.save_train_dir = './../12_group_mel_pa/data_train/';
opts.save_test_dir  = './../12_group_mel_pa/data_test/';

% For input data TODO
opts.train_dir  =  '../12_split_mel_pa/data_train/';
opts.test_dir   =  '../12_split_mel_pa/data_test/';
